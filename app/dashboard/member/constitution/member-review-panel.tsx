...
export function MemberReviewPanel({ draftId }: { draftId: string }) {
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="space-y-1">
                ...
                <Textarea value={comment} onChange={(e) => setComment(e.target.value)} placeholder="Enter your comments or proposed changes here..." rows={6} className="border-gray-200 text-sm" />
            </div>
