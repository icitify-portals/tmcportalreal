            ...
            <header className="sticky top-0 z-50 w-full border-b bg-green-700/95 backdrop-blur supports-[backdrop-filter]:bg-green-700/60 text-white shadow-sm">
                <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-2 font-bold text-xl">
                        ...
                        <span className="hidden md:inline text-sm font-medium bg-green-800/50 px-3 py-1 rounded-full border border-green-600/50">{safeOrg.name}</span>
                    </div>
                    <nav className="hidden md:flex items-center gap-6 text-sm font-medium">
                        <Link href="/" className="hover:text-green-200 transition-colors">Home</Link>
                        <Link href="/connect" className="text-green-100 hover:text-white transition-colors">Connect</Link>
                        <Link href="#" className="hover:text-green-200 transition-colors">Events</Link>
