...
import { getMeetingAttendanceTokenAction } from "@/lib/actions/meetings"
import { Loader2, RefreshCcw, Users, Clock, ShieldCheck } from "lucide-react"

export function MeetingAttendanceKiosk({ meetingId, meetingTitle }: { meetingId: string, meetingTitle: string }) {
    ...
    const fetchToken = async () => {
        setLoading(true)
        const result = await getMeetingAttendanceTokenAction(meetingId)
    ...
    return (
        <div className="flex flex-col items-center justify-center space-y-8 text-center">
            <div className="space-y-2">
                <h1 className="text-5xl font-black text-gray-900 tracking-tight">{meetingTitle}</h1>
