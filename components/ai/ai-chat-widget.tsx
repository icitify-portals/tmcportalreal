...
import { Bot, Send, X, User as UserIcon, Loader2, Minimize2, MessageCircle } from "lucide-react"
...
export function AiChatWidget() {
    ...
    const [isEnabled, setIsEnabled] = useState(false) // Default false to avoid flash if disabled.
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        {error && (
                            <div className="p-3 rounded-md bg-destructive/10 text-destructive text-xs text-center">
                                Error encountered. Please check API keys or try again.
                                <br />{error.message}
                            </div>
                        )}
                        <div ref={scrollRef} className="h-1" /> {/* Scroll anchor */}
                    </div>
                </ScrollArea>
